...
<section class="officials-section">
    ...
    <div class="title-container scroll-animate">
        ...
        <h2 class="mayor-title"><i class="fa-solid fa-calculator"></i>Municipal Accounting Office</h2>
    </div>
    ...
    <div class="officials-grid">
        <div class="official-card scroll-animate">
            <img src="assets/accounting/boy.png" alt="Staff">
            <h3>Hedino Tubo JR.</h3>
            <p>Clerk</p>
        </div>
        <div class="official-card scroll-animate">
            <img src="assets/accounting/girl.png" alt="Staff">
            <h3>Maria Cristina I. Peña</h3>
        ...
        <div class="official-card scroll-animate">
            <img src="assets/accounting/girl.png" alt="Staff">
            <h3>Debbie Jane P. Recitas</h3>
            <p>Revenue Collection Clerk I (RCC I)</p>
        </div>
        <div class="official-card scroll-animate">
            <img src="assets/accounting/girl.png" alt="Staff">
            <h3>Reynalyn S. Mendoza</h3>
            <p>Job Order</p>
        </div>
    </div>
