...
<section>
    ...
    <div class="content-section">
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ANNUALPROCUREMENTPLAN-COMMON-USESUPPLIESANDEQUIPMENT(APP-CSE)2024FORM.pdf" target="_blank" download>📄 DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ANNUALPROCUREMENTPLAN-COMMON-USESUPPLIESANDEQUIPMENT(APP-CSE)2024FORMOTHERITEMS.pdf" target="_blank" download>📄 DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/RehabilitationofPortEssentialFacilities(GuardPost,MaleCR,CausewayDamagePortion),Brgy.Kalanggaman&Brgy.Iniguihan,Bato,Leyte.pdf" target="_blank" download>📄 DOWNLOAD</a>
        </div>

        <div class="document-card">
            <img src="assets/app-cse/2.jpeg" alt="APP-CSE Cover" style="width:100%; border-radius:8px; margin-bottom:20px;">
            <p>Rehabilitation of Port Essential Facilities (Guard Post, Male CR, Causeway Damage Portion), Brgy. Kalanggaman & Brgy. Iniguihan, Bato, Leyte</p>
            <a href="assets/app-cse/RehabilitationofPortEssentialFacilities.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurmentofOne(1)UnitBrandNewCrawlerExcavator.pdf" target="_blank" download>📄 DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurementofOne(1)UnitBrandNewHeavyDutyGlassCrusher.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurementofOne(1)UnitBrandNew4x26WheelerDumptruck.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurementofFuelOilandLubricants.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/RehabilitationofBatoWetMarketBuilding,Brgy.Iniguihan,Bato,Leyte.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurementofDrugsandMedicinesforRHU-Bato,Leyte.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurementofOfficeSuppliesandConsumablesforthe1stQuarterof2025,Bato,Leyte.pdf" target="_blank" download>📄DOWNLOAD</a>
        </div>
        ...
        <div class="document-card">
            ...
            <a href="assets/app-cse/ProcurementofMedicalSuppliesforAnimalBiteProgramServicesforRHU-Bato,Leyte.pdf" target="_blank" download>📄 DOWNLOAD</a>
        </div>
