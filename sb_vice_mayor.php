...
<section class="officials-section">
    ...
    <div class="top-official scroll-animate">
        <img src="assets/vice/vice.png" alt="Vice Mayor">
        <h3>Hon. Nathaniel B. Gertos</h3>
    ...
    <div class="officials-grid">
        ...
        <div class="official-card scroll-animate">
            <img src="assets/vice/boy.png">
            <h3>Hon. Anthony S. Echevarre</h3>
            <p>Sangguniang Bayan Member</p>
        </div>
        ...
        <div class="official-card scroll-animate">
            <img src="assets/vice/mark.jpg">
            <h3>Hon. Mark S. Salvatierra</h3>
            <p>Sangguniang Bayan Member</p>
        </div>
        ...
        <div class="official-card scroll-animate">
            <img src="assets/vice/marisa.jpg">
            <h3>Marissa C. Gertos</h3>
            <p>LNB President</p>
        </div>
