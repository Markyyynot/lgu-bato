...
<section class="officials-section">
    ...
    <div class="title-container scroll-animate">
        ...
        <h2 class="mayor-title"><i class="fa-solid fa-money-bill"></i>Municipal Treasurer’s Office</h2>
    </div>

    <!-- TREASURER -->
    <div class="top-official scroll-animate">
        <img src="assets/treasurer/kriz.jpg" alt="Treasurer">
        <h3>Kriszar A. Navarrosa</h3>
        <p>Asst. Municipal Treasurer/ MGADH</p>
    </div>
    ...
    <div class="officials-grid">
        ...
        <div class="official-card scroll-animate">
            <img src="assets/treasurer/girl.png" alt="Cashier">
            <h3>Lyn C. Alfante</h3>
            <p>Admin Aide I</p>
        </div>
        <div class="official-card scroll-animate">
        ...
        <div class="official-card scroll-animate">
            <img src="assets/treasurer/boy.png" alt="Cashier">
            <h3>Romeo B. Lota</h3>
            <p>Job Order</p>
        </div>
        <div class="official-card scroll-animate">
        ...
        <div class="official-card scroll-animate">
            <img src="assets/treasurer/s.jpg" alt="Cashier">
            <h3>Mary Glace S. Sanoria</h3>
            <p>Job Order</p>
        </div>
    </div>
